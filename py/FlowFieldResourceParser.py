...
def flow一条龙(ncfilepath, outputDIR):
...
def wind一条龙(ncfilepath, outputDIR):
...
if __name__ == '__main__':
    ncfile = "./output/0412/adcirc_addwind0412.nc"
    outputdir = "./output/test"
    flow一条龙(ncfile, outputdir)
    print("flow resources are built successfully!")
    print("====================================")
    wind一条龙(ncfile,outputdir)
